(()=>{
  function apply(){
    ...
    s.textContent=`
      ...
      .match-card .teams>strong{min-width:0!important;display:flex!important;align-items:center!important;gap:12px!important;padding:10px 10px!important;min-height:54px!important;border-radius:16px!important}
      ...
      @media(max-width:520px){
        ...
        .match-card .teams>strong{min-height:52px!important;padding:8px 8px!important;gap:8px!important;border-radius:15px!important}
        .match-card .teams>strong:last-child{justify-content:flex-end!important;text-align:right!important}
        .match-card .vm-team-flag{font-size:36px!important;min-width:38px!important;width:38px!important}
        .match-card .vm-team-name{font-size:14px!important;line-height:1.05!important;font-weight:1000!important;color:#fff!important;letter-spacing:-.02em!important;text-shadow:0 2px 5px rgba(0,0,0,.55)!important}
      }
    `;
