(()=>{
  ...
  function addSafeProfileLayout(){
    ...
    if(p){p.className='safe-profile-subtitle';p.innerHTML='<span class="safe-rank">Legende ⭐</span>VM-tipster • Chess Lounge member';}
  }
